...
function App() {
  const [messages, setMessages] = useState([
    {
      message: "Hello, I'm a Tomato Farmer! Ask me anything!",
      sentTime: "just now",
      sender: "ChatGPT"
    }
  ]);
  ...
  return (
    <div className="App">
      <div style={{ position:"relative", height: "800px", width: "300px"  }}>
        <MainContainer>
          <ChatContainer>       
            <MessageList 
              scrollBehavior="smooth" 
              typingIndicator={isTyping ? <TypingIndicator content="Tomato Farmer is typing" /> : null}
            >
